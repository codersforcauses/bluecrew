...
urlpatterns = [
    ...
    path('friends/requests/outgoing/', friends_views.get_outgoing_requests, name='outgoing_requests'),
    path('friends/requests/incoming/', friends_views.get_incoming_requests, name='incoming_requests'),
