...
urlpatterns = [
    ...
    path('friends/requests/outgoing/', views.get_outgoing_requests, name='outgoing_requests'),
    path('friends/requests/incoming/', views.get_incoming_requests, name='incoming_requests'),
