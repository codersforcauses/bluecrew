  ...
  <footer class="footer">
    <div class="footer-content">
      ...
      <div v-else class="mobile-layout">
        <div v-if="!isExpanded" class="mobile-footer-collapsed" @click="toggleFooter">
